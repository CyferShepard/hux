...
class HuxSearchableDropdown<T> extends StatefulWidget {
  ...
  final List<HuxSearchableDropdownItem<T>> items;
  ...
  @override
  State<HuxSearchableDropdown<T>> createState() => _HuxSearchableDropdownState<T>();
}

class _HuxSearchableDropdownState<T> extends State<HuxSearchableDropdown<T>> {
  final GlobalKey _buttonKey = GlobalKey();
  bool _isOpen = false;
  final TextEditingController _searchController = TextEditingController();
  String get _searchQuery => _searchController.text;
  List<HuxSearchableDropdownItem<T>> get filteredItems =>
      widget.items.where((item) => item.searchValue.toLowerCase().contains(_searchQuery.toLowerCase())).toList();
  ...
  String get _displayText {
    ...
    final item = widget.items.firstWhere(
      ...
      orElse: () => HuxSearchableDropdownItem(value: widget.value as T, child: Text('${widget.value}'), searchValue: ''),
    );
